...
public class CardItemRecommendedCategoryAdapterRv extends RecyclerView.Adapter<CardItemRecommendedCategoryAdapterRv.ViewHolder>{

    private  List<CardItemRecommendedCategoryModel> list = new ArrayList<>();

    public CardItemRecommendedCategoryAdapterRv() {
    }

    public CardItemRecommendedCategoryAdapterRv(List<CardItemRecommendedCategoryModel> list) {
        this.list = list;
    }
